    ...
    extend: {
      ...
      keyframes: {
        ...
        'divine-float': {
          ...
          '50%': { transform: 'translate(5px, -50px)', opacity: '0.8' },
      ...
      animation: {
        ...
        'divine-float': 'divine-float ease-in-out infinite',
        'subtle-drift': 'subtle-drift ease-in-out infinite alternate',
        'negative-dart': 'negative-dart ease-in-out infinite alternate',
      },
    },
  },
