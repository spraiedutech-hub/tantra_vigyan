...
export default function ChakraPractitioner() {
  return (
    <svg viewBox="0 0 300 400" className="w-full h-full max-w-sm max-h-full">
      ...
      {/* Chakras */}
      {/* 7. Sahasrara (Crown) */}
      <g transform="translate(150, 85)" className="animate-chakra-spin-slow-reverse">
      ...
      <text x="180" y="90" className="text-xs fill-foreground animate-float-fade" style={{ animationDelay: '0s' }}>ಸಹಸ್ರಾರ</text>
