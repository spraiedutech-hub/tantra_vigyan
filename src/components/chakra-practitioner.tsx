  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-4">
      <svg viewBox="0 0 300 400" className="w-full h-full max-w-sm max-h-full">
        ...
        {/* Chakras */}
        {/* 7. Sahasrara (Crown) */}
        <g transform="translate(150, 70)" className="animate-chakra-spin-slow-reverse">
        ...
        <text x="175" y="75" className="text-xs fill-foreground animate-float" style={{ animationDelay: '0s' }}>ಸಹಸ್ರಾರ</text>
        ...
        <text x="170" y="120" className="text-xs fill-foreground animate-float" style={{ animationDelay: '0.2s' }}>ಆಜ್ಞಾ</text>
        ...
        <text x="170" y="165" className="text-xs fill-foreground animate-float" style={{ animationDelay: '0.4s' }}>ವಿಶುದ್ಧ</text>
        ...
        <text x="175" y="215" className="text-xs fill-foreground animate-float" style={{ animationDelay: '0.6s' }}>ಅನಾಹತ</text>
        
        {/* 3. Manipura (Solar Plexus) */}
        <g transform="translate(150, 260)" className="animate-chakra-spin-slow">
           <path d="M0 -10 L10 10 L-10 10 Z" fill="#FFFF00" className="animate-chakra-glow opacity-80" />
        </g>
        <text x="175" y="265" className="text-xs fill-foreground animate-float" style={{ animationDelay: '0.8s' }}>ಮಣಿಪುರ</text>
        
        {/* 2. Svadhisthana (Sacral) */}
        <g transform="translate(150, 310)" className="animate-chakra-pulse">
          <circle r="11" fill="#FF8C00" className="animate-chakra-glow opacity-80" />
          <circle r="5" fill="none" stroke="white" strokeWidth="1" />
        </g>
        <text x="175" y="315" className="text-xs fill-foreground animate-float" style={{ animationDelay: '1s' }}>ಸ್ವಾಧಿಷ್ಠಾನ</text>
        
        {/* 1. Muladhara (Root) */}
        <g transform="translate(150, 360)" className="animate-chakra-spin">
          <rect x="-8" y="-8" width="16" height="16" fill="#FF0000" className="animate-chakra-glow opacity-80" />
        </g>
        <text x="175" y="365" className="text-xs fill-foreground animate-float" style={{ animationDelay: '1.2s' }}>ಮೂಲಾಧಾರ</text>
      </svg>
    </div>
  );
}
