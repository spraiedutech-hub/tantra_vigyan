...
function getPageDescription(href: string): string {
    switch (href) {
        ...
        case '/sadhana':
            return "ಪ್ರತಿದಿನ ನಿಮಗಾಗಿ ವಿಶೇಷವಾಗಿ ರಚಿಸಲಾದ ಹೊಸ, AI-ಚಾಲಿತ ಆಧ್ಯಾತ್ಮಿಕ ಅಭ್ಯಾಸವನ್ನು (ಸಾಧನಾ) ಪಡೆಯಿರಿ. ಇದು ಸಂಕಲ್ಪ, ಮಂತ್ರ, ಪ್ರಾಣಾಯಾಮ ಮತ್ತು ಧ್ಯಾನವನ್ನು ಒಳಗೊಂಡಿರುತ್ತದೆ.";
        case '/initiation':
            return "ತಂತ್ರ ಮಾರ್ಗದಲ್ಲಿ ದೀಕ್ಷೆಯ ಮಹತ್ವ, ಅದರ ಪ್ರಕಾರಗಳು ಮತ್ತು ದೀಕ್ಷೆ ಪಡೆಯುವ ಪ್ರಕ್ರಿಯೆಯ ಬಗ್ಗೆ ವಿವರವಾಗಿ ತಿಳಿಯಿರಿ.";
        case '/guidance':
            return "ಸಾಧನೆಯ ಮಾರ್ಗದಲ್ಲಿ ಎದುರಾಗಬಹುದಾದ ಅಡೆತಡೆಗಳ ಬಗ್ಗೆ ತಿಳಿಯಿರಿ. ನಿಮ್ಮ ವೈಯಕ್ತಿಕ ಸಮಸ್ಯೆಗಳಿಗೆ AI ಗುರುವಿನಿಂದ ಮಾರ್ಗದರ್ಶನವನ್ನು ಪಡೆಯಲು ಸಂವಾದಾತ್ಮಕ ಸಾಧನವನ್ನು ಬಳಸಿ.";
        case '/activities':
            return "ನಿಮ್ಮ ಆಧ್ಯಾತ್ಮಿಕ ಅಭ್ಯಾಸವನ್ನು ಹೆಚ್ಚಿಸಲು ಸರಳವಾದ ತಾಂತ್ರಿಕ ಕ್ರಿಯೆಗಳು ಮತ್ತು ಆಚರಣೆಗಳನ್ನು ಅನ್ವೇಷಿಸಿ.";
        case '/remedies':
            return "ನಿಮ್ಮ ದೈನಂದಿನ ಜೀವನದ ಸವಾಲುಗಳಿಗೆ, ವಿಶೇಷವಾಗಿ ಆರ್ಥಿಕ ಮತ್ತು ಇತರ ಸಮಸ್ಯೆಗಳಿಗೆ, ಸರಳವಾದ, AI- ರಚಿತ ತಾಂತ್ರಿಕ ಮತ್ತು ಆಧ್ಯಾತ್ಮಿಕ ಪರಿಹಾರಗಳನ್ನು ಪಡೆಯಿರಿ.";
        case '/recommendations':
            return "ನಿಮ್ಮ ಅನುಭವ, ಲಭ್ಯವಿರುವ ಸಮಯ ಮತ್ತು ಗುರಿಗಳ ಆಧಾರದ ಮೇಲೆ ವೈಯಕ್ತಿಕಗೊಳಿಸಿದ ಮಂತ್ರ ಮತ್ತು ಚಟುವಟಿಕೆಗಳ ಶಿಫಾರಸುಗಳನ್ನು ಪಡೆಯಿರಿ. ಜೊತೆಗೆ, ದೈನಂದಿನ ಸಮಸ್ಯೆಗಳಿಗೆ ಪರಿಹಾರಗಳನ್ನು ಹುಡುಕಿ.";
        case '/articles':
            return "ತಂತ್ರಕ್ಕೆ ಸಂಬಂಧಿಸಿದ ಯಾವುದೇ ವಿಷಯದ ಬಗ್ಗೆ AI ಸಹಾಯದಿಂದ ಆಳವಾದ ಲೇಖನಗಳನ್ನು ರಚಿಸಿ ಮತ್ತು ಓದಿ.";
        case '/knowledge':
