    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <ScrollAnimate delay={150}>
        <Alert variant="destructive" className="border-accent/50 text-accent [&>svg]:text-accent">
          ...
          <AlertDescription>
            ಈ ಪುಟದಲ್ಲಿನ ಮಾಹಿತಿಯು ಆಧ್ಯಾತ್ಮಿಕ ಮತ್ತು ಶೈಕ್ಷಣಿಕ ಉದ್ದೇಶಕ್ಕಾಗಿ ಮಾತ್ರ. ಇದು ಯಾವುದೇ ರೀತಿಯ ಹಣಕಾಸು ಸಲಹೆಯಲ್ಲ. ತಾಂತ್ರಿಕ ಅಭ್ಯಾಸಗಳು ಶ್ರದ್ಧೆ ಮತ್ತು ವೈಯಕ್ತಿಕ ಪ್ರಯತ್ನವನ್ನು ಅವಲಂಬಿಸಿವೆ.
          </AlertDescription>
        </Alert>
      </ScrollAnimate>
