      ...
      <ScrollAnimate>
        <Card>
            ...
            <CardContent className="prose prose-lg dark:prose-invert max-w-full text-foreground/90">
                <p>
                ಕಾಲಜ್ಞಾನವೆಂದರೆ 'ಕಾಲದ ಜ್ಞಾನ'. ಇದು ಭೂತ, ವರ್ತಮಾನ ಮತ್ತು ಭವಿಷ್ಯದ ಬಗ್ಗೆ ಅತೀಂದ್ರಿಯ ಶಕ್ತಿಯ ಮೂಲಕ ಪಡೆದ ಜ್ಞಾನವಾಗಿದೆ. ಭಾರತೀಯ ಪರಂಪರೆಯಲ್ಲಿ, ಶ್ರೀ ಪೋತುಲೂರಿ ವೀರಬ್ರಹ್ಮೇಂದ್ರ ಸ್ವಾಮಿಗಳಂತಹ ಅನೇಕ ಮಹಾಪುರುಷರು ಮತ್ತು ಸಿದ್ಧರು ತಮ್ಮ ದಿವ್ಯದೃಷ್ಟಿಯಿಂದ ಭವಿಷ್ಯದಲ್ಲಿ ನಡೆಯುವ ಘಟನೆಗಳನ್ನು ಮುಂಚಿತವಾಗಿಯೇ ಗ್ರಹಿಸಿ, ಅವುಗಳನ್ನು ತಾಳೆಗರಿಗಳಲ್ಲಿ ಅಥವಾ ವಚನಗಳ ರೂಪದಲ್ಲಿ ದಾಖಲಿಸಿದ್ದಾರೆ. ಅಂತೆಯೇ, ನಾಸ್ಟ್ರಾಡಾಮಸ್‌ನಂತಹ ಪಾಶ್ಚಿಮಾತ್ಯ ದಾರ್ಶನಿಕರೂ ಸಹ ತಮ್ಮದೇ ಆದ ರೀತಿಯಲ್ಲಿ ಭವಿಷ್ಯದ ಬಗ್ಗೆ ಬರೆದಿದ್ದಾರೆ.
                </p>
                <p>
