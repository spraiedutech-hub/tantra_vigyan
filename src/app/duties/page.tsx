           ...
           <ScrollAnimate key={index} delay={index * 100}>
               <Card className="transform hover:scale-[1.01] transition-transform duration-300 ease-in-out">
                <AccordionItem value={`item-${index}`} className="border-b-0">
                    <AccordionTrigger className="text-xl font-headline text-accent hover:no-underline p-6">
                        <div className="flex items-center gap-3">
                            <duty.icon className="w-6 h-6 text-accent"/>
                            <span>{duty.title}</span>
                        </div>
                    </AccordionTrigger>
                    <AccordionContent className="p-6 pt-0">
                        <div className="prose prose-lg dark:prose-invert max-w-full text-foreground/90 text-justify leading-relaxed">
                            <p>{duty.content}</p>
                        </div>
                    </AccordionContent>
                </AccordionItem>
